...
for k in 5 10 15 20 25 30
do
  for num_of_points in 100 1000 2000 3000 4000 5000 6000
  do
    K=$k NUM_OF_POINTS=$num_of_points mvn exec:java -D exec.mainClass=edu.hanyang.smallest2019.SpeedTestApp
  done
done
