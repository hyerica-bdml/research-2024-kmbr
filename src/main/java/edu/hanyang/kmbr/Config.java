...
public class Config {
    ...
    public static final int K = Integer.parseInt(System.getenv().getOrDefault("K", "15"));
//    public static final int POINTSET_SIZE = Integer.parseInt(System.getenv().getOrDefault("POINTSET_SIZE", "15"));
    ...
    public static final int NUM_OF_POINTS = Integer.parseInt(System.getenv().getOrDefault("NUM_OF_POINTS", "1000"));
    public static final int NUM_OF_GROUPS = Integer.parseInt(System.getenv().getOrDefault("NUM_OF_GROUPS", "30"));
    public static final int NUM_OF_ITERATIONS = Integer.parseInt(System.getenv().getOrDefault("NUM_OF_ITERATIONS", "1"));
    ...
    public static final int POINTSET_SIZE;

    static {
        int pointset_size = Integer.parseInt(System.getenv().getOrDefault("POINTSET_SIZE", "-1"));
        if (pointset_size == -1)
            POINTSET_SIZE = K;
        else
            POINTSET_SIZE = pointset_size;
    }
