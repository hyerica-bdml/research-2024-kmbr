...
public class Config {
    ...
    public static final int K = Integer.parseInt(System.getenv().getOrDefault("K", "5"));
//    public static final int POINTSET_SIZE = Integer.parseInt(System.getenv().getOrDefault("POINTSET_SIZE", "15"));
    ...
    public static final int NUM_OF_POINTS = Integer.parseInt(System.getenv().getOrDefault("NUM_OF_POINTS", "3000"));
    public static final int NUM_OF_GROUPS = Integer.parseInt(System.getenv().getOrDefault("NUM_OF_GROUPS", "10"));
    public static final int NUM_OF_ITERATIONS = Integer.parseInt(System.getenv().getOrDefault("NUM_OF_ITERATIONS", "10"));
