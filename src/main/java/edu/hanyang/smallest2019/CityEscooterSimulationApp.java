...
public class CityEscooterSimulationApp {
    ...
    public static void main(String[] args) {
        new CityEscooterSimulationApp().run(
                ...
                String.format("logs/related_works/smallest2019/city_Lousiville_escooter_trip_start_streaming_K%d-2018-10.txt", Config.K)
        );
        new CityEscooterSimulationApp().run(
                "data/city-lousiville-escooter-trip-data/parsed/city_Lousiville_escooter_trip_start_streaming-2019-1.txt",
                String.format("logs/related_works/smallest2019/city_Lousiville_escooter_trip_start_streaming_K%d-2019-1.txt", Config.K)
        );
        new CityEscooterSimulationApp().run(
                "data/city-lousiville-escooter-trip-data/parsed/city_Lousiville_escooter_trip_start_streaming-2019-4.txt",
                String.format("logs/related_works/smallest2019/city_Lousiville_escooter_trip_start_streaming_K%d-2019-4.txt", Config.K)
        );
        new CityEscooterSimulationApp().run(
                "data/city-lousiville-escooter-trip-data/parsed/city_Lousiville_escooter_trip_start_streaming-2019-7.txt",
                String.format("logs/related_works/smallest2019/city_Lousiville_escooter_trip_start_streaming_K%d-2019-7.txt", Config.K)
        );
    }
            ...
            while ((line = bin.readLine()) != null) {
                ...
                if (split[0].equals("create")) {
                    ...
                    if (iteration % 500 == 0) {
                        ...
                        Smallest2019 method = new Smallest2019(clusterAssignments);
                        method.find();
